...
import { calculateSeatPrice } from "../pages/Purchase";
              ...
              {tickets.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-gray-500 max-w-md">
                    You haven't purchased any tickets yet. Browse movies and
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {tickets.map((ticket, index) => {
                    const totalAmount = ticket.seats.reduce(
                      (total, seat) => total + calculateSeatPrice(seat, ticket.showtime),
                      0
                    );
                    ...
                    return (
                      <div
                        ...
                        key={index}>
                        <div
                          className={`absolute -right-8 top-4 w-32 rotate-45 transform py-1 text-center text-xs font-bold ${
                            new Date(ticket.showtime.showtime) > new Date()
                        ...
                        <div className="p-5">
                          ...
                          <div className="mt-2 flex items-center justify-between">
                            ...
                            <span className="text-lg font-semibold text-[#ff416c]">
                              {ticket.showtime.movie.showType}
                            </span>
                          </div>
                          <div className="mt-2 flex items-center justify-between">
                          ...
                          <div className="mt-2 flex items-center justify-between">
                            ...
                            <span className="text-lg font-semibold text-[#ff416c]">
                              {ticket.showtime.movie.language}
                            </span>
                          </div>
                          <div className="mt-2 flex items-center justify-between">
                            <h4 className="font-medium text-gray-300">Total Amount</h4>
                            <span className="text-lg font-semibold text-[#ff416c]">
